...
public class arrays {
	...
	public static void main(String[] args) {
		...
		// Create a string array. The address of the string is stored, not the string
		// itself.
		...
		System.out.println("En kucuk sayi " + a[0]);
		System.out.println("a arrayin uzunlugu " + a.length);
		System.out.println("En buyuk sayi " + a[a.length-1]);

		// Use the sort() method for b array.
		// In string arrays, the sort() method sorts alphabetically.
		// In Java, "Natural Order" is used instead of small to size and alphabetical
		// sorting
